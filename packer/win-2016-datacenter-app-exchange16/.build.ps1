...
$ex16Variables       = Get-JSON "$packerTemplatesPath/win-2016-datacenter-exchange16/variables.json"
$ex16Provisioners    = Get-JSON "$packerTemplatesPath/win-2016-datacenter-exchange16/provisioners.json"
