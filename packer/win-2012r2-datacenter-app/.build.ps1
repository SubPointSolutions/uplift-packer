...
$appVariables      = Get-JSON "$packerTemplatesPath/win-2012r2-datacenter-app/variables.json"
$appProvision      = Get-JSON "$packerTemplatesPath/win-2012r2-datacenter-app/provisioners.json"
