...
$coreBuilder       = Get-JSON "$packerTemplatesPath/common/builders-win-10-iso.json"
...
$bareVariables     = Get-JSON "$packerTemplatesPath/win-10-enterprise-bare/variables.json"
